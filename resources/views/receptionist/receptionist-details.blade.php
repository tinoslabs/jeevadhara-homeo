                ...
                @if ($receptionist)
                    ...
                    @else
                        <a href="{{ url('receptionist/' . $receptionist->id) }}">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Back to Receptionist Profile') }}
                            </button>
                        </a>
                    @endif
                @else
                    <a href="{{ url('receptionist') }}">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Back to Receptionist List') }}
                        </button>
                    </a>
                @endif
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <img class="@error('profile_photo') is-invalid @enderror"
                                                src="@if ($receptionist && $receptionist->profile_photo != null){{ URL::asset('storage/images/users/' . $receptionist->profile_photo) }}@else{{ URL::asset('build/images/users/noImage.png') }}@endif" id="profile_display" onclick="triggerClick()"
