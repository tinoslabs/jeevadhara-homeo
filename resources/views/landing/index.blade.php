...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top navbar-custom sticky sticky-light"
                ...
                <div class="container">
                    <a class="navbar-brand logo" href="#!">
                        <img src="{{ URL::asset('build/images') . '/' . AppSetting('logo_dark_lg') }}" alt=""
                            height="22">
                    </a>
                    ...
                    <div class="row align-items-center justify-content-between g-3 g-lg-5">
                        ...
                        <div class="col-lg-7 align-self-end">
                            <div class="img-part ms-auto">
                                <img src="{{ URL::asset('build/images/landing/doctor-team.png') }}" alt="doctor"
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-5">
                            <div class="features-img">
                                <img src="{{ URL::asset('build/images/landing/doctor-2.png') }}" alt="doctor"
                                    class="img-fluid">
                                ...
                                <div class="swiper-wrapper mb-5">
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-4.png') }}"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-3.png') }}"
                                                alt="doctor" class="img-fluid">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-5.png') }}"
                                                alt="doctor" class="img-fluid">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-6.png') }}"
                                                alt="doctor" class="img-fluid">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-7.jpg') }}"
                                                alt="doctor" class="img-fluid">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-8.jpg') }}"
                                                alt="doctor" class="img-fluid">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3">
                                            <img src="{{ URL::asset('build/images/landing/doctor-9.jpg') }}"
                                                alt="doctor" class="img-fluid">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="doctor-img shadow-sm p-3 mb-2">
                                            <img src="{{ URL::asset('build/images/landing/doctor-10.jpg') }}"
                                                alt="doctor" class="img-fluid">
                            ...
                            <div class="swiper-container testi-slider pb-5 overflow-hidden">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide bg-light">
                                        <div class="testi-box p-3 position-relative">
                                            <div class="user-img shadow-sm p-3 bg-white rounded-3">
                                                <img src="{{ URL::asset('build/images/landing/img-1.jpg') }}"
                                    ...
                                    <div class="swiper-slide bg-light">
                                        <div class="testi-box p-3 position-relative">
                                            <div class="user-img shadow-sm p-3 bg-white rounded-3">
                                                <img src="{{ URL::asset('build/images/landing/img-2.jpg') }}"
                                                    alt="doctor" class="img-fluid rounded-circle w-25 mx-auto">
                                                <div class="user-detail mt-3 text-center">
                                    ...
                                    <div class="swiper-slide bg-light">
                                        <div class="testi-box p-3 position-relative">
                                            <div class="user-img shadow-sm p-3 bg-white rounded-3">
                                                <img src="{{ URL::asset('build/images/landing/img-4.jpg') }}"
                                                    alt="doctor" class="img-fluid rounded-circle w-25 mx-auto">
                                                <div class="user-detail mt-3 text-center">
                                    ...
                                    <div class="swiper-slide bg-light">
                                        <div class="testi-box p-3 position-relative">
                                            <div class="user-img shadow-sm p-3 bg-white rounded-3">
                                                <img src="{{ URL::asset('build/images/landing/img-3.png') }}"
                                                    alt="doctor" class="img-fluid rounded-circle w-25 mx-auto">
                                                <div class="user-detail mt-3 text-center">
        ...
        <div class="container">
            ...
            <div class="form-part mt-5">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-lg-5">
                        <img src="{{ URL::asset('build/images/landing/doctor-7.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <section class="section faq-section pb-3" id="faqs">
                <div class="container">
                    ...
                    <div class="row align-items-center justify-content-between g-3 g-lg-5">
                        ...
                        <div class="col-lg-6">
                            <img src="{{ URL::asset('build/images/landing/Online Doctor-pana.png') }}" alt=""
                                class="img-fluid">
                ...
                <div class="row justify-content-between g-2">
                    <div class="col-lg-4">
                        <a class="brand-logo" href="#!">
                            <img src="{{ URL::asset('build/images') . '/' . AppSetting('logo_lg') }}" alt=""
                            height="22">
                        </a>
        ...
        <div class="footer-copyright p-4">
            <div class="container">
                <div class="text-center">
                    <p class="text-white m-0">© {{ date('Y') }} . Crafted with by Themesbrand</p>
                </div>
            </div>
        </div>
    ...
    <script src="{{ URL::asset('build/js/landing.js') }}"></script>
</body>
