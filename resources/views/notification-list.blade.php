                                ...
                                <div data-simplebar>
                                    @forelse ($notification as $item)
                                        <a href="/notification/{{ $item->id }}" class="text-reset notification-item">
                                            <div class="d-flex mb-3 p-2 {{ $item->read_at == null ? 'bg-light' : '' }}">
                                                <img src="@if ($item->user->profile_photo != ''){{ URL::asset('storage/images/users/' . $item->user->profile_photo) }}@else{{ URL::asset('build/images/users/noImage.png') }}@endif" class="me-3 rounded-circle avatar-xs"
                                                    alt="user-pic">
