            ...
            <div class="col-12">
                <a href="{{ url('prescription') }}">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i
                            class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Back to Prescription List') }}
                    </button>
                </a>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="outer-repeater" action="{{ route('prescription.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">{{ __('Symptoms ') }}<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">{{ __('Diagnosis ') }}<span
                                            class="text-danger">*</span></label>
