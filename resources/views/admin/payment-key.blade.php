                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('payment-key.store') }}" method="post">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="payment_key"> Key <span class="text-danger">*</span></label>
                                <input name="razorpay_key" value="{{ $razorpay != null ? $razorpay->key : '' }}"
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="payment_key"> Secret <span class="text-danger">*</span></label>
                                <input name="razorpay_secret" value="{{ $razorpay != null ? $razorpay->secret : '' }}"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('payment-key.store') }}" method="post">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="payment_key"> Key <span class="text-danger">*</span></label>
                                <input name="stripe_key" value="{{ $stripe != null ? $stripe->key : '' }}" class="form-control"
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="payment_key"> Secret <span class="text-danger">*</span></label>
                                <input name="stripe_secrets" value="{{ $stripe != null ? $stripe->secret : '' }}"
                                    class="form-control" placeholder="Enter Stripe Secret">
                            ...
                            <div class="d-flex">
                                ...
                                @if ($stripe)
                                    <div class="">
                                        <a href="javascript:void(0)" class="btn btn-danger" data-id="{{ $stripe->id }}"
                                            id="delete-api">
                                            {{ __('Delete') }}
                                        </a>
                                    </div>
