...
@section('title') {{ __('Accountant Profile') }} @endsection
    @section('content')
        <!-- start page title -->
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('accountant') }}">{{ __('Receptionists') }}</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="@if ($accountant->profile_photo != ''){{ URL::asset('storage/images/users/' . $accountant->profile_photo) }}@else{{ URL::asset('build/images/users/noImage.png') }}@endif" alt="{{ $accountant->fisrt_name }}"
                            ...
                            <div class="col-sm-8">
                                <div class="pt-4">
                                    ...
                                    @if ($role == 'admin')
                                        <div class="mt-4">
                                            <a href="{{ url('accountant/' . $accountant->id . '/edit') }}"
