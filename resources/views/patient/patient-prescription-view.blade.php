                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            <h4 class="float-end font-size-16">Prescription #{{ $user_details->id }}</h4>
                            <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="py-2 mt-3">
                                    <h3 class="font-size-15 fw-bold">{{ __('Medications') }}</h3>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="py-2 mt-3">
                                    <h3 class="font-size-15 fw-bold">{{ __('Test Reports') }}</h3>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
