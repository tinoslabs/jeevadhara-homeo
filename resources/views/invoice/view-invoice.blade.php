                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            <h4 class="float-end font-size-16">{{ __('Invoice #') }} {{ $invoice_detail->id }}</h4>
                            <div class="mb-4">
                        ...
                        <div class="py-2 mt-3">
                            <h3 class="font-size-15 fw-bold">{{ __('Invoice summary') }}</h3>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-0 text-end">${{ ($sub_total * 5) / 100 }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="border-0 text-end">
