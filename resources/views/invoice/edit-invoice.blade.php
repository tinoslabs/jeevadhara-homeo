            ...
            <div class="col-12">
                <a href="{{ url('invoice') }}">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Back to Invoice List') }}
                    </button>
                </a>
            </div>
        </div>
                        ...
                        <form class="outer-repeater" action="{{ url('invoice/' . '' . $invoice_detail->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">{{ __('Patient') }}<span
                                ...
                                @if ($role == 'doctor' || $role == 'accountant')
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">{{ __('Appointment ') }}<span
                                                class="text-danger">*</span></label>
                                        <select
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    value="{{ @$invoice_detail->appointment->doctor->user->first_name .' '.@$invoice_detail->appointment->doctor->user->last_name }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">{{ __('Payment Mode ') }}<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">{{ __('Payment Status ') }}<span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class='repeater mb-4'>
                                        <div data-repeater-list="invoices" class="mb-3">
