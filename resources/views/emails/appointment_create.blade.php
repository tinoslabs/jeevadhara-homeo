                    ...
                    <td style="padding: 30px 24px 0; color: #161c2d; font-size: 18px;">
                        ...
                        <table style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    <td><b>Name: </b>{{ $MailAppointment->BookedBy->first_name .' '. $MailAppointment->BookedBy->last_name}}</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td><b>Contact: </b>{{ $MailAppointment->BookedBy->mobile }}</td>
                                </tr>
                                <tr>
                                    <td><b>Email: </b>{{ $MailAppointment->BookedBy->email }}</td>
                                </tr>
                            </tbody>
                        </table>
                        <br />
