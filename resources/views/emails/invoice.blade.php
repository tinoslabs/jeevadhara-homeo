...
<head>
    ...
    <title>Invoice  | {{ AppSetting('title'); }}</title>
</head>
​
                    ...
                    <td style="padding: 30px 24px 0; color: #161c2d; font-size: 18px;">
                        ...
                        <table style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    <td><b>Name: </b>{{ @$invoice->doctor->user->first_name .' '. @$invoice->doctor->user->last_name}}</td>
                                    <td>{{ $invoice->created_at }}</td>
                                </tr>
                                <tr>
                                    <td><b>Contact: </b>{{ @$invoice->doctor->user->mobile }}</td>
                                    <td><b>Appointment Date&Time: </b></td>
                                </tr>
                                <tr>
                                    <td><b>Email: </b>{{ @$invoice->doctor->user->email }}</td>
