...
<head>
    ...
    <title>Prescription  | {{ AppSetting('title'); }}</title>
</head>
​
                    ...
                    <td style="padding: 30px 24px 0; color: #161c2d; font-size: 18px;">
                        <table style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    <td><b>Name: </b>{{ @$prescription->doctor->user->first_name .' '. @$prescription->doctor->user->last_name}}</td>
                                    <td>{{ $prescription->created_at }}</td>
                                </tr>
                                <tr>
                                    <td><b>Contact: </b>{{ @$prescription->doctor->user->mobile }}</td>
                                    <td><b>Appointment Date&Time: </b></td>
                                </tr>
                                <tr>
                                    <td><b>Email: </b>{{ @$prescription->doctor->user->email }}</td>
