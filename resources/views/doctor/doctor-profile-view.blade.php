                    ...
                    <div class="card-body">
                        ...
                        @if ($availableDay)
                            @if ($availableDay->sun == 1)
                                <span class="badge bg-info font-size-15 my-2">Sunday</span>
                            @endif
                            @if ($availableDay->mon == 1)
                                <span class="badge bg-info font-size-15 my-2">Monday</span>
                            @endif
                            @if ($availableDay->tue == 1)
                                <span class="badge bg-info font-size-15 my-2">Tuesday</span>
                            @endif
                            @if ($availableDay->wen == 1)
                                <span class="badge bg-info font-size-15 my-2">Wednesday</span>
                            @endif
                            @if ($availableDay->thu == 1)
                                <span class="badge bg-info font-size-15 my-2">Thursday</span>
                            @endif
                            @if ($availableDay->fri == 1)
                                <span class="badge bg-info font-size-15 my-2">Friday</span>
                            @endif
                            @if ($availableDay->sat == 1)
                                <span class="badge bg-info font-size-15 my-2">Saturday</span>
                            @endif
                        @endif
                        <hr>
                        <p>Available Time</p>
