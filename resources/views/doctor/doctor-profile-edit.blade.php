                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <img class="@error('profile_photo') is-invalid @enderror"
                                                src="@if ($user->profile_photo != ''){{ URL::asset('storage/images/users/' . $user->profile_photo) }}@else{{ URL::asset('build/images/users/noImage.png') }}@endif" id="profile_display" onclick="triggerClick()"
