                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="@if ($doctor->profile_photo != ''){{ URL::asset('storage/images/users/' . $doctor->profile_photo) }}@else{{ URL::asset('build/images/users/noImage.png') }}@endif" alt="{{ $doctor->first_name }}"
                    ...
                    <div class="card-body">
                        ...
                        @if ($availableDay)
                            @if ($availableDay->sun == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Sunday') }}</span>
                            @endif
                            @if ($availableDay->mon == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Monday') }}</span>
                            @endif
                            @if ($availableDay->tue == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Tuesday') }}</span>
                            @endif
                            @if ($availableDay->wen == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Wednesday') }}</span>
                            @endif
                            @if ($availableDay->thu == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Thursday') }}</span>
                            @endif
                            @if ($availableDay->fri == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Friday') }}</span>
                            @endif
                            @if ($availableDay->sat == 1)
                                <span class="badge bg-info font-size-15 my-2">{{ __('Saturday') }}</span>
                            @endif
                        @endif
                        <hr>
                        <p>Available Time</p>
                        @if ($availableTime)
                            @foreach ($availableTime as $item)
                                <span class="badge bg-info font-size-15 my-2">
