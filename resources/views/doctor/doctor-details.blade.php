...
@section('css-bottom')
    <link rel="stylesheet" type="text/css"
        href="{{ URL::asset('build/libs/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}">
@endsection
    @section('content')
        <!-- start page title -->
        <div class="row">
                        ...
                        <form id="addtime" action="@if ($doctor && $doctor_info) {{ url('doctor/' . $doctor->id) }} @else {{ route('doctor.store') }} @endif" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">{{ __('Profile Photo ') }}<span
                                                    class="text-danger">*</span></label>
                                            <img class="@error('profile_photo') is-invalid @enderror"
                                                src="@if ($doctor && $doctor_info && $doctor->profile_photo != 'noImage.png') {{ URL::asset('storage/images/users/' . $doctor->profile_photo) }}  @else {{ URL::asset('build/images/users/noImage.png') }} @endif" id="profile_display" onclick="triggerClick()"
